                      ...
                      %>
                        <div class="item">
                          <div class="project-info">
                            <img src="myproject/<%=projectFile.getFilename() %>" class="img-fluid" alt="project image">
                          </div>
                        </div>
                        <%} %>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                  <h2 class="mb-4 mobile-mt-2">Educations</h2>
                    ...
                    <div class="timeline">
                    <%
                    	ArrayList <EducationDTO> ed= new EducationDaoImpl().readEducation();
                    	for(EducationDTO x :ed)
                    	{
                    %>
                        <div class="timeline-wrapper">
                             <div class="timeline-yr">
                             ...
                             <div class="timeline-info">
                                  <h3><span><%=x.getTitle() %></span><small><%=x.getSubtitle() %></small></h3>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mr-lg-5 col-12">
            <div class="google-map w-100">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.865109059677!2d77.602103675122!3d12.916390087393944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1592e392a4dd%3A0x9031dc816823d591!2sKodNest%20-%20Code%2C%20Transform%20and%20Succeed!5e0!3m2!1sen!2sin!4v1760521042275!5m2!1sen!2sin" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
